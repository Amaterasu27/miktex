       ...
       int urx, int ury, int llx, int lly)
{
  ...
  */
  ...
  if (flags & NO_GSSAFER) {
    DEBUG_PRINT(DEBUG_GS,
		("\n  GS CALL:\t%s %s %s %s %s %s %s %s %s %s ",/* %s",*/
		 ...
		 "-dTextAlphaBits=4", "-dGraphicsAlphaBits=4",
		 "-"));
    sprintf(szArguments,"%s %s %s %s %s %s %s %s %s",/* %s",*/
    ...
    DEBUG_PRINT(DEBUG_GS,
		("\n  GS CALL:\t%s %s %s %s %s %s %s %s %s %s %s ",/* %s",*/
		 ...
		 "-dTextAlphaBits=4", "-dGraphicsAlphaBits=4",
		 "-"));
    sprintf(szArguments,"%s %s %s %s %s %s %s %s %s %s",/* %s",*/
	    device, resolution, /*devicesize,*/
	    "-dBATCH", "-dNOPAUSE", "-dSAFER", "-q", 
	    "-sOutputFile=-", 
	    "-dTextAlphaBits=4", "-dGraphicsAlphaBits=4",
  ...
  miktex_start_process (szGsPath, szArguments, INVALID_HANDLE_VALUE,
