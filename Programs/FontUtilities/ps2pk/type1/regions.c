...
*/
#if defined (__alpha) /* FP: added __alpha */
       ...
       fractpel dy;          /* direction and magnitude of change in y       */
{
       ...
       if (type != CD_FIRST) {
	       ...
	       /* FP: FIXME not as much parameters as here. */ 
...
*/
static void vertjoin(top, bottom) /* FP: return type void */
...
static void discard(left, right) /* FP: return type void */
