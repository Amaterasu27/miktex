...
/* FP: Definition of a PostScript FONT             */
...
/************************/
#ifdef WIN32 /* FP: Unfortunately, there is such a function in the Win32 API */
...
/* inside the stem.                                                */
/*******************************************************************/
static void ComputeStem(stemno) /* FP void */
int stemno;
{
...
#if defined(MIKTEX)
  unsigned int currkey; /* current decryption key */
#else
...
static void ClearStack() /* FP void */
{
  Top = -1;
}
 
static void Push(Num) /* FP void */
        DOUBLE Num;
{
...
static void ClearCallStack() /* FP void */
{
  CallTop = -1;
}
 
static void PushCall(CurrStrP, CurrIndex, CurrKey) /* FP void */
  psobj *CurrStrP;
  int CurrIndex;
#if defined(MIKTEX)
...
static void PopCall(CurrStrPP, CurrIndexP, CurrKeyP) /* FP void */
  psobj **CurrStrPP;
  int *CurrIndexP;
#if defined(MIKTEX)
  unsigned int *CurrKeyP;
#else
...
static void ClearPSFakeStack() /* FP void */
{
  PSFakeTop = -1;
}
 
/* PSFakePush: Pushes a number onto the fake PostScript stack */
static void PSFakePush(Num) /* FP void */
  DOUBLE Num;
{
...
#if defined(MIKTEX) 
static unsigned int r; /* Pseudo-random sequence of keys */
#else
...
static void Decode(Code) /* FP void */
  int Code;
{
...
static void DoCommand(Code) /* FP void */
  int Code;
{
  switch(Code) {
...
static void Escape(Code) /* FP void */
  int Code;
{
  int i, Num;
  struct segment *p;
...
static void HStem(y, dy) /* FP void */
  DOUBLE y, dy;
{
...
static void VStem(x, dx) /* FP void */
  DOUBLE x, dx;
{
...
static void RLineTo(dx, dy) /* FP void */
  DOUBLE dx, dy;
{
  struct segment *B;
...
/* (dx1+dx2) (dy1+dy2) (dx1+dx2+dx3) */
/* (dy1+dy2+dy3) RCURVETO in PostScript */
static void RRCurveTo(dx1, dy1, dx2, dy2, dx3, dy3) /* FP void */
...
/* Closes a subpath WITHOUT repositioning the */
/* current point */
static void DoClosePath() /* FP void */
{
...
/* Calls a CharString subroutine with index */
/* subr# from the Subrs array */
static void CallSubr(subrno) /* FP void */
  int subrno;
{
...
/* |- dx dy RMOVETO |- */
/* Behaves like RMOVETO in PostScript */
static void RMoveTo(dx,dy) /* FP void */
  DOUBLE dx,dy;
{
  struct segment *B;
...
/* Brackets an outline section for the dots in */
/* letters such as "i", "j", and "!". */
static void DotSection() /* FP void */
{
...
/* Standard Encoding Accented Character. */
static void Seac(asb, adx, ady, bchar, achar) /* FP void */
  DOUBLE asb, adx, ady;
...
/* Set the left sidebearing point to (sbx,sby), */
/* set the character width vector to (wx,wy). */
static void Sbw(sbx, sby, wx, wy) /* FP void */
...
static void CallOtherSubr(othersubrno) /* FP void */
  int othersubrno;
{
...
/* character space coordinates without per- */
/* forming a CharString MOVETO command */
static void SetCurrentPoint(x, y) /* FP void */
  DOUBLE x, y;
{
