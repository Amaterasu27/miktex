...
static int __cdecl cmpTrueTypeLocaOffset(const void *p1, const void *p2) {
#else
...
#if defined(MIKTEX_WINDOWS)
static int __cdecl cmpTrueTypeLocaIdx(const void *p1, const void *p2) {
#else
...
#if defined(MIKTEX_WINDOWS)
static int __cdecl cmpTrueTypeTableTag(const void *p1, const void *p2) {
#else
