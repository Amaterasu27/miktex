...
$Id: epdf.h,v 1.14 2005/07/17 20:58:40 csc Exp $
*/

#if defined(MIKTEX)
#include "miktex/kpsemu.h"
#  if defined(MIKTEX_PDFETEX)
#    include "pdfetex-miktex.h"
#  else
...
extern integer get_fontfile(fm_entry *);
extern integer get_fontname(fm_entry *);
#else
...
#if defined(MIKTEX) && defined(__cplusplus)
extern void embed_whole_font(fm_entry *);
#else
...
#if defined(MIKTEX) && defined(__cplusplus)
extern void mark_glyphs(fm_entry *, char *);
#else
