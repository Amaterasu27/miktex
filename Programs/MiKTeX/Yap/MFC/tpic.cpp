...
/* _________________________________________________________________________
   ...
   DviView::DrawTpicSpecial
   _________________________________________________________________________ */

void
DviView::DrawTpicSpecial (/*[in]*/ CDC *		pDC,
			  /*[in]*/ TpicSpecial *	pTpicSpecial)
{
  tpicConv = CalcTpicConv(GetDocument()->GetResolution(),
			    GetDocument()->GetMagnification());
  CPen pen;
  int penSize =
    PixelShrink(static_cast<int>(pTpicSpecial->GetPenSize() * tpicConv));
  if (penSize == 0)
    {
      penSize = 1;
    }
  ...
  if ((pPolySpecial = dynamic_cast<TpicPolySpecial *>(pTpicSpecial)) != 0)
    {
  ...
  else if ((pArcSpecial = dynamic_cast<TpicArcSpecial *>(pTpicSpecial)) != 0)
    {
...
/* _________________________________________________________________________
   ...
   DviView::DrawTpicPoly
   _________________________________________________________________________ */

void
DviView::DrawTpicPoly (/*[in]*/ CDC *			pDC,
		       /*[in]*/ TpicPolySpecial *	pPoly)
{
  float length;
  switch (pPoly->GetOutlineStyle(length).Get())
    {
...
/* _________________________________________________________________________
   ...
   DviView::DrawTpicSpline
   _________________________________________________________________________ */

void
DviView::DrawTpicSpline (/*[in]*/ CDC *			pDC,
			 /*[in]*/ TpicPolySpecial *	pPoly)
{
  float length;
  switch (pPoly->GetOutlineStyle(length).Get())
...
/* _________________________________________________________________________
   ...
   DviView::DrawTpicEllipse
   _________________________________________________________________________ */

const double TWOPI = 3.14159265359 * 2.0;

void
DviView::DrawTpicEllipse (/*[in]*/ CDC *	pDC,
			  /*[in]*/ int		x,
			  /*[in]*/ int		y,
			  /*[in]*/ int		xc,
			  /*[in]*/ int		yc,
...
void
DviView::DrawTpicArc (/*[in]*/ CDC *		pDC,
...
/* _________________________________________________________________________
   ...
   DviView::FlushTpicPath
   _________________________________________________________________________ */

void
DviView::FlushTpicPath (/*[in]*/ CDC *				pDC,
			/*[in]*/ int				x,
			/*[in]*/ int				y,
...
/* _________________________________________________________________________
   ...
   DviView::FlushTpicSpline
   _________________________________________________________________________ */

inline
int
dist (/*[in]*/ const TpicSpecial::point & pt0,
      /*[in]*/ const TpicSpecial::point & pt1)
{
  return (abs(pt0.x - pt1.x) + abs(pt0.y - pt1.y));
}

void
DviView::FlushTpicSpline (/*[in]*/ CDC *			pDC,
			  /*[in]*/ int				x,
			  /*[in]*/ int				y,
			  /*[in]*/ const TpicSpecial::path &	path)
{
  ...
  for (unsigned i = 0; i < path2.size() - 2; ++ i)
    {
      int steps =
	((dist(path2[i], path2[i+1]) + dist(path2[i+1], path2[i+2])) / 80);
      for (int j = 0; j < steps; ++j)
	{
	  ...
	  TpicSpecial::point pt;
	  pt.x =
	    ((t1*path2[i+2].x + t2*path2[i+1].x + t3*path2[i].x + 50000)
	     / 100000);
	  pt.y =
	    ((t1*path2[i+2].y + t2*path2[i+1].y + t3*path2[i].y + 50000)
	     / 100000);
	  if (lastvalid)
	    {
...
/* _________________________________________________________________________
   ...
   DviView::DrawTpicLine
   _________________________________________________________________________ */

void
DviView::DrawTpicLine (/*[in]*/ CDC *				pDC,
		       /*[in]*/ int				x,
		       /*[in]*/ int				y,
		       /*[in]*/ const TpicSpecial::point &	ptFrom,
		       /*[in]*/ const TpicSpecial::point &	ptTo)
{
  pDC->MoveTo (PixelShrink(static_cast<int>(x + ptFrom.x * tpicConv)),
	       PixelShrink(static_cast<int>(y + ptFrom.y * tpicConv)));
...
/* _________________________________________________________________________
   ...
   DviView::FlushTpicPathD
   _________________________________________________________________________ */

void
DviView::FlushTpicPathD (/*[in]*/ CDC *				pDC,
			 /*[in]*/ int				x,
			 /*[in]*/ int				y,
			 /*[in]*/ const TpicSpecial::path &	path,
...
#if 0
	  pDC->SetPixel (PixelShrink(x + cx0 * tpicConv),
			 PixelShrink(y + cy0 * tpicConv),
			 RGB(0,0,0)); // fixme
#else
	  pDC->MoveTo (PixelShrink(static_cast<int>(x + cx0 * tpicConv)),
