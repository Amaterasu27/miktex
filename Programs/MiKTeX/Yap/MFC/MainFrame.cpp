...
BEGIN_MESSAGE_MAP(MainFrame, CMDIFrameWnd)
  ...
  ON_COMMAND(ID_CONTINUOUS_DOUBLE, OnContinuousDouble)
  ON_COMMAND(ID_CONTINUOUS_SINGLE, OnContinuousSingle)
  ON_COMMAND(ID_DEFAULT_HELP, CMDIFrameWnd::OnHelpFinder)
  ON_COMMAND(ID_DOUBLE_PAGE, OnDoublePage)
  ON_COMMAND(ID_HELP, CMDIFrameWnd::OnHelp)
  ON_COMMAND(ID_HELP_FINDER, CMDIFrameWnd::OnHelpFinder)
  ON_COMMAND(ID_HELP_KEYBOARD, OnHelpKeyboard)
  ON_COMMAND(ID_SINGLE_PAGE, OnSinglePage)
  ON_COMMAND(ID_VIEW_FULLSCREEN, OnViewFullScreen)
  ON_COMMAND(ID_VIEW_OPTIONS, OnViewOptions)
  ON_UPDATE_COMMAND_UI(ID_CONTINUOUS_DOUBLE, OnUpdateContinuousDouble)
  ON_UPDATE_COMMAND_UI(ID_CONTINUOUS_SINGLE, OnUpdateContinuousSingle)
  ON_UPDATE_COMMAND_UI(ID_DOUBLE_PAGE, OnUpdateDoublePage)
  ON_UPDATE_COMMAND_UI(ID_INDICATOR_COMMAND_PREFIX, OnUpdateCommandPrefix)
  ON_UPDATE_COMMAND_UI(ID_INDICATOR_PAGE_M_OF_N, OnUpdatePageMofN)
  ON_UPDATE_COMMAND_UI(ID_INDICATOR_POINT, OnUpdatePoint)
  ON_UPDATE_COMMAND_UI(ID_INDICATOR_SOURCE, OnUpdateSource)
  ON_UPDATE_COMMAND_UI(ID_SINGLE_PAGE, OnUpdateSinglePage)
