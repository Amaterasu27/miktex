...
class MagnifyingGlassOptionsPage : public CPropertyPage
{
private:
...
protected:
  afx_msg
  void
  OnChangeSmallShrinkFactor ();

protected:
  afx_msg
  void
  OnChangeMediumShrinkFactor ();

protected:
  afx_msg
  void
  OnChangeLargeShrinkFactor ();

protected:
  afx_msg
  void
  OnClickHideMouseCursor ();
