...
BEGIN_MESSAGE_MAP(DviView, CMyScrollView)
  ...
  ON_COMMAND(ID_DARKER_TEXT, OnDarkerText)
  ON_COMMAND(ID_DOCUMENT_DOWN, OnDocumentDown)
  ON_COMMAND(ID_DOCUMENT_UP, OnDocumentUp)
  ON_COMMAND(ID_END, OnEnd)
  ON_COMMAND(ID_FILE_DOCUMENT_PROPERTIES, OnFileDocumentProperties)
  ON_COMMAND(ID_FILE_DVIPS, OnFileDvips)
  ...
  ON_COMMAND(ID_LIGHTER_TEXT, OnLighterText)
  ...
  ON_COMMAND(ID_PAGE_EDITOR, OnPageEditor)
  ON_COMMAND(ID_PREV_PAGE, OnPrevPage)
  ON_COMMAND(ID_SB_LINEDOWN, OnLineDown)
  ON_COMMAND(ID_SB_LINELEFT, OnLineLeft)
  ON_COMMAND(ID_SB_LINERIGHT, OnLineRight)
  ON_COMMAND(ID_SB_LINEUP, OnLineUp)
  ON_COMMAND(ID_SB_PAGEDOWN, OnPageDown)
  ON_COMMAND(ID_SB_PAGELEFT, OnPageLeft)
  ON_COMMAND(ID_SB_PAGERIGHT, OnPageRight)
  ON_COMMAND(ID_SB_PAGEUP, OnPageUp)
  ON_COMMAND(ID_TOOLS_ARROW, OnToolsArrow)
  ON_COMMAND(ID_TOOLS_HAND, OnToolsHand)
  ON_COMMAND(ID_TOOLS_MAGNIFYING_GLASS, OnToolsMagnifyingGlass)
  ON_COMMAND(ID_TOOLS_SOURCESPECIALS, OnToolsSourcespecials)
  ...
  ON_UPDATE_COMMAND_UI(ID_LIGHTER_TEXT, OnUpdateLighterText)
  ...
  ON_UPDATE_COMMAND_UI(ID_PREV_PAGE, OnUpdatePrevPage)
  ON_UPDATE_COMMAND_UI(ID_TOOLS_ARROW, OnUpdateToolsArrow)
  ON_UPDATE_COMMAND_UI(ID_TOOLS_HAND, OnUpdateToolsHand)
  ON_UPDATE_COMMAND_UI(ID_TOOLS_MAGNIFYING_GLASS, OnUpdateToolsMagnifyingGlass)
