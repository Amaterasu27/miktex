...
/* _________________________________________________________________________
   ...
   Ruler::PreCreateWindow
   _________________________________________________________________________ */

BOOL
Ruler::PreCreateWindow (/*[in,out]*/ CREATESTRUCT & cs) 
{
...
void
Ruler::Create (/*[in]*/ const CPoint & point)
{
  if (! classRegistered)
    {
      WNDCLASS wndcls;
...
void
Ruler::MoveRuler (/*[in]*/ const CPoint & point)
{
  MoveWindow (point.x,
	      point.y,
	      sizeWindow.cx,
