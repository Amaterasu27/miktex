...
http://www.enst.fr\label{id185504}\begingroup\catcode`\#=12\footnote{ \url{http://www.enst.fr/\string&x}}\endgroup\docbooktolatexmakefootnoteref{id185504} \url{http://www.enst.fr/\string&x}

This is might also make this sentence long enough for the regular text blah http://www.enst.fr/\_\textasciitilde{}\#top {\texttt{{http:/\dbz{}/\dbz{}www.\dbz{}enst.\dbz{}fr/\dbz{}\_\dbz{}\textasciitilde{}\#top}}}\label{id185512}\begingroup\catcode`\#=12\footnote{ \url{http://www.enst.fr/#top}}\endgroup\docbooktolatexmakefootnoteref{id185512} \url{http://www.enst.fr/#top}

ENST\label{id185524}\begingroup\catcode`\#=12\footnote{ \url{http://www.enst.fr}}\endgroup\docbooktolatexmakefootnoteref{id185524} \url{http://www.enst.fr}

\texttt{<email\label{id185531}\begingroup\catcode`\#=12\footnote{ \url{mailto:email}}\endgroup\docbooktolatexmakefootnoteref{id185531} \url{mailto:email}>}
