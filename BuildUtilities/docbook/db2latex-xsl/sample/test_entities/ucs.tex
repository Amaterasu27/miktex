...
% --------------------------------------------
\makeatletter
\usepackage[]{ucs}\catcode`\&=\active\def&{\@ifnextchar##{\@docbooktolatexunicode\@gobble}{\&}}
...
\label{id176193}\hypertarget{id176193}{}%
...
\begin{tabular}{|c|c|}
\hline 
1 \catcode`\&=4 &\catcode`\&=\active 1 \tabularnewline
 \hline 
2 \catcode`\&=4 &\catcode`\&=\active 8 \tabularnewline
 \hline 
3 \catcode`\&=4 &\catcode`\&=\active 27 \tabularnewline
\hline 
\end{tabular}
\end{center}
...
\label{id176339}\hypertarget{id176339}{}%
\subsection{Regular}
