...
struct ScriptTable
{
    ...
    const LangSysTable  U_EXPORT *findLanguage(LETag languageTag, le_bool exactMatch = FALSE) const;
};
...
struct ScriptListTable
{
    ...
    const ScriptTable   U_EXPORT *findScript(LETag scriptTag) const;
    const LangSysTable  U_EXPORT *findLanguage(LETag scriptTag, LETag languageTag, le_bool exactMatch = FALSE) const;
};
