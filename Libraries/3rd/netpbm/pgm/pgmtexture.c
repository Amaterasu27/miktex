...
float f1_asm ARGS((float **P, int Ng));
float f2_contrast ARGS((float **P, int Ng));
float f3_corr ARGS((float **P, int Ng));
float f4_var ARGS((float **P, int Ng));
float f5_idm ARGS((float **P, int Ng));
float f6_savg ARGS((float **P, int Ng));
float f7_svar ARGS((float **P, int Ng, float S));
float f8_sentropy ARGS((float **P, int Ng));
float f9_entropy ARGS((float **P, int Ng));
float f10_dvar ARGS((float **P, int Ng));
float f11_dentropy ARGS((float **P, int Ng));
float f12_icorr ARGS((float **P, int Ng));
float f13_icorr ARGS((float **P, int Ng));
float f14_maxcorr ARGS((float **P, int Ng));
float *vector ARGS((int nl, int nh));
float **matrix ARGS((int nrl, int nrh, int ncl, int nch));
void results ARGS((char *c, float *a));
void simplesrt ARGS((int n, float arr[]));
void mkbalanced ARGS((float **a, int n));
void reduction ARGS((float **a, int n));
void hessenberg ARGS((float **a, int n, float wr[], float wi[]));
