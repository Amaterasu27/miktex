...
int process_atk_byte ARGS((int *pcurcount, unsigned char *pcurbyte, FILE *file,
                      unsigned char newbyte, int eolflag));
int write_atk_bytes ARGS((FILE *file, unsigned char curbyte, unsigned int curcount));
