...
/* prototypes */
void output_sixel_record ARGS((unsigned char *record, int width));
void convert ARGS((int width, int height, int format));


void output_sixel_record (record, width)
...
void convert (width, height, format)
   int width ;
   int height ;
   int format ;
{
   ...
   char **argv ;
{
   ...
   char *opt_form_length = opt_bottom_margin;
