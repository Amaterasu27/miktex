...
{
  fprintf (stderr, "%s: warning: ", (module ? module : "pnmtotiff"));
...
{
  fprintf (stderr, "%s: error: ", (module ? module : "pnmtotiff"));
  vfprintf (stderr, fmt, ap);
  fprintf (stderr, ".\n");
}
#endif /* MiKTeX */
...
#  if defined(_WIN32) && defined(_MSC_VER)
    /* libtiff 3.4 uses OS handles. */
    tif = TIFFFdOpen( _get_osfhandle(1), "Standard Output", "w" );
#  else
    FIXME, PLEASE!
#  endif
#else
