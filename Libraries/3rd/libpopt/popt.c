...
#if defined(MIKTEX) && defined(MIKTEXPOPTAPI)
MIKTEXPOPTAPI(int) poptSaveLong(long * arg, int argInfo, long aLong)
#else
...
#if defined(MIKTEX) && defined(MIKTEXPOPTAPI)
MIKTEXPOPTAPI(const char *) poptGetOptArg(poptContext con)
#else
...
#if defined(MIKTEX) && defined(MIKTEXPOPTAPI)
MIKTEXPOPTAPI(const char *) poptBadOption(poptContext con, int flags)
#else
