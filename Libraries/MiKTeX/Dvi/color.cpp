...
/* _________________________________________________________________________
   ...
   DviImpl::ParseColorSpec
   _________________________________________________________________________ */

bool
DviImpl::ParseColorSpec (/*[in]*/ const char *		lpsz,
			 /*[in]*/ unsigned long &	rgb)
{
  ...
  if (isRgb || isHsb || isCmyk || isGray)
      ...
      else if (isCmyk)
	{
	  ...
	  if ((sscanf_s(lpsz, "%f %f %f %f", &frac1, &frac2, &frac3, &frac4)
	       != 4)
	      || frac1 < 0.0 || frac1 > 1.0
	      || frac2 < 0.0 || frac2 > 1.0
	      || frac3 < 0.0 || frac3 > 1.0
...
/* _________________________________________________________________________
   ...
   DviImpl::SetCurrentColor
   _________________________________________________________________________ */

bool
DviImpl::SetCurrentColor (/*[in]*/ const char *	lpszColor)
{
