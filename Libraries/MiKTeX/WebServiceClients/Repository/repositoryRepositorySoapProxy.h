...
{ public:
	...
	RepositorySoapProxy(const char *url);
	/// Constructor with engine input+output mode control
	RepositorySoapProxy(soap_mode iomode);
	/// Constructor with URL and input+output mode control
	RepositorySoapProxy(const char *url, soap_mode iomode);
	...
	virtual	int GetRepositories3(_ns1__GetRepositories3 *ns1__GetRepositories3, _ns1__GetRepositories3Response *ns1__GetRepositories3Response) { return GetRepositories3(NULL, NULL, ns1__GetRepositories3, ns1__GetRepositories3Response); }
	virtual	int GetRepositories3(const char *endpoint, const char *soap_action, _ns1__GetRepositories3 *ns1__GetRepositories3, _ns1__GetRepositories3Response *ns1__GetRepositories3Response);

	/// Web service operation 'PickRepository3' (returns error code or SOAP_OK)
	virtual	int PickRepository3(_ns1__PickRepository3 *ns1__PickRepository3, _ns1__PickRepository3Response *ns1__PickRepository3Response) { return PickRepository3(NULL, NULL, ns1__PickRepository3, ns1__PickRepository3Response); }
	virtual	int PickRepository3(const char *endpoint, const char *soap_action, _ns1__PickRepository3 *ns1__PickRepository3, _ns1__PickRepository3Response *ns1__PickRepository3Response);
};
#endif
