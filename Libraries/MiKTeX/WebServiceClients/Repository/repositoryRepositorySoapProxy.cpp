...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___mtrep4__TryGetRepositoryInfo(soap, &soap_tmp___mtrep4__TryGetRepositoryInfo, "-mtrep4:TryGetRepositoryInfo", "")
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__PickRepository(soap, &soap_tmp___mtrep4__PickRepository, "-mtrep4:PickRepository", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__GetAllRepositories(soap, &soap_tmp___mtrep4__GetAllRepositories, "-mtrep4:GetAllRepositories", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__GetRepositories(soap, &soap_tmp___mtrep4__GetRepositories, "-mtrep4:GetRepositories", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__GetListCreationTime(soap, &soap_tmp___mtrep4__GetListCreationTime, "-mtrep4:GetListCreationTime", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__GetRepositories2(soap, &soap_tmp___mtrep4__GetRepositories2, "-mtrep4:GetRepositories2", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__PickRepository2(soap, &soap_tmp___mtrep4__PickRepository2, "-mtrep4:PickRepository2", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__TryGetRepositoryInfo2(soap, &soap_tmp___mtrep4__TryGetRepositoryInfo2, "-mtrep4:TryGetRepositoryInfo2", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__VerifyRepository(soap, &soap_tmp___mtrep4__VerifyRepository, "-mtrep4:VerifyRepository", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__TryGetRepositoryInfo_(soap, &soap_tmp___mtrep4__TryGetRepositoryInfo_, "-mtrep4:TryGetRepositoryInfo", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__PickRepository_(soap, &soap_tmp___mtrep4__PickRepository_, "-mtrep4:PickRepository", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__GetAllRepositories_(soap, &soap_tmp___mtrep4__GetAllRepositories_, "-mtrep4:GetAllRepositories", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__GetRepositories_(soap, &soap_tmp___mtrep4__GetRepositories_, "-mtrep4:GetRepositories", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__GetListCreationTime_(soap, &soap_tmp___mtrep4__GetListCreationTime_, "-mtrep4:GetListCreationTime", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__GetRepositories2_(soap, &soap_tmp___mtrep4__GetRepositories2_, "-mtrep4:GetRepositories2", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__PickRepository2_(soap, &soap_tmp___mtrep4__PickRepository2_, "-mtrep4:PickRepository2", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__TryGetRepositoryInfo2_(soap, &soap_tmp___mtrep4__TryGetRepositoryInfo2_, "-mtrep4:TryGetRepositoryInfo2", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct soap *soap = this;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___mtrep4__VerifyRepository_(soap, &soap_tmp___mtrep4__VerifyRepository_, "-mtrep4:VerifyRepository", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
