...
RepositorySoapProxy::RepositorySoapProxy(const char *url)
{	RepositorySoapProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = url;
}
...
RepositorySoapProxy::RepositorySoapProxy(const char *url, soap_mode iomode)
{	RepositorySoapProxy_init(iomode, iomode);
	soap_endpoint = url;
}
...
int RepositorySoapProxy::GetRepositories3(const char *endpoint, const char *soap_action, _ns1__GetRepositories3 *ns1__GetRepositories3, _ns1__GetRepositories3Response *ns1__GetRepositories3Response)
{	struct soap *soap = this;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns2__GetRepositories3.ns1__GetRepositories3 = ns1__GetRepositories3;
	soap_begin(soap);
	soap_serializeheader(soap);
...
int RepositorySoapProxy::PickRepository3(const char *endpoint, const char *soap_action, _ns1__PickRepository3 *ns1__PickRepository3, _ns1__PickRepository3Response *ns1__PickRepository3Response)
{	struct soap *soap = this;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns2__PickRepository3.ns1__PickRepository3 = ns1__PickRepository3;
	soap_begin(soap);
	soap_serializeheader(soap);
