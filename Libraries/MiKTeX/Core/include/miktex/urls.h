...
#define MIKTEX_URL_WWW_REGISTRATION MIKTEX_URL_WWW MIKTEXTEXT("giveback")

#define MIKTEX_URL_WWW_PACKAGING MIKTEX_URL_WWW "pkg/about"

#define MIKTEX_URL_WWW_KNOWN_ISSUES \
  MIKTEX_URL_WWW MIKTEXTEXT(MIKTEX_SERIES_STR) MIKTEXTEXT("/issues")

#define MIKTEX_URL_WWW_SUPPORT MIKTEX_URL_WWW MIKTEXTEXT("support")
