/* miktex/Core/Environment.h: MiKTeX environment strings	-*- C++ -*-
...
#define MIKTEX_ENV_INSTALL MIKTEX_ENV_PREFIX_ "INSTALL"
...
#define MIKTEX_ENV_ROOTS MIKTEX_ENV_PREFIX_ "ROOTS"
#define MIKTEX_ENV_STARTUP_FILE MIKTEX_ENV_PREFIX_ "STARTUPFILE"
