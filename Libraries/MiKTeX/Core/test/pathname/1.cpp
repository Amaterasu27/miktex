...
{
  TEST (PathName::Compare ("//aBc/[e]/ghi.jkl",
			   "//aBc/[e]/qwe.rty",
			   10)
	== 0);
  TEST (PathName::Compare ("/abc/def/ghi.jkl",
			   "/abc/def/qwe.rty",
			   10)
	!= 0);
  ...
  PathName::Split ("/abc/def/ghi.jkl",
...
BEGIN_TEST_FUNCTION(2);
{
  ...
  ++ component2;
  TEST (PathName::Compare(component2.GetCurrent(), "ghi.jkl")
	== 0);
  ++ component2;
